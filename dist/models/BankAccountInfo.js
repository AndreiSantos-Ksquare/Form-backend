...
const setupBankAccountInfo = (sequelize) => __awaiter(void 0, void 0, void 0, function* () {
    BankAccountInfo.init({
        ...
        acc_number: sequelize_1.DataTypes.INTEGER,
        clabe: sequelize_1.DataTypes.INTEGER,
